...
| مخفف | علامت‌ها | نمونه‌ها |
| --- | --- | --- |
| همراه اول | 🔰⚛️ 4️⃣ | https://***.workers.dev/clash/MCI |
| رایتل | 🔰⚛️ 4️⃣ | https://***.workers.dev/clash/RTL |
| آسیاتک | 🔰⚛️ | https://***.workers.dev/clash/AST |
| ایرانسل | 🔰⚛️ 4️⃣ 🔰 | https://***.workers.dev/clash/IRC |
| شاتل | 🔰⚛️ 4️⃣ | https://***.workers.dev/clash/SHT |
| مخابرات | 🔰⚛️ 4️⃣ | https://***.workers.dev/clash/MKB |
| مبین نت | 🔰⚛️ | https://***.workers.dev/clash/MBT |
| زیتل | 🔰⚛️ | https://***.workers.dev/clash/ZTL |
| پارس آنلاین | 🔰⚛️ | https://***.workers.dev/clash/PRS |
| های وب | 🔰⚛️ | https://***.workers.dev/clash/HWB |
| پیشگامان | 🔰⚛️ | https://***.workers.dev/clash/PIS |
| رهام داتک | | https://***.workers.dev/clash/DAT |
| صبا نت | 4️⃣🔰 | https://***.workers.dev/clash/SAB |
| عصر تلکام | | https://***.workers.dev/clash/ASR |
| فن آوا | 🔰⚛️ | https://***.workers.dev/clash/FAN |
| صفر و یک | | https://***.workers.dev/clash/SFR |
| دیده بان نت | 🔰⚛️ | https://***.workers.dev/clash/DID |
| لایزر | | https://***.workers.dev/clash/LAY |
| ماهان نت | | https://***.workers.dev/clash/MAH |
| تک نت | | https://***.workers.dev/clash/TAK |
| پتیاک | | https://***.workers.dev/clash/PET |
| اندیشه سبز | 🔰⚛️ | https://***.workers.dev/clash/AND |
| رسپینا | 🔰⚛️ 4️⃣ | https://***.workers.dev/clash/RES |
| افرانت | 🔰⚛️ | https://***.workers.dev/clash/AFR |
| آراکس | 🔰⚛️ | https://***.workers.dev/clash/ARA |
| سامانتل | 🔰⚛️ | https://***.workers.dev/clash/SAM |
| آپتل | 🔰⚛️ | https://***.workers.dev/clash/APT |
| فناپ تلکام | 🔰⚛️ | https://***.workers.dev/clash/FNP |
| راینت | 🔰⚛️ | https://***.workers.dev/clash/RYN |
| IPV6 | 6️⃣ | https://***.workers.dev/clash/IPV6 |
| IRCF | 🔰 | https://***.workers.dev/clash/IRCF |
| سایتای خارجی | 🌐 | https://***.workers.dev/clash/ENG |
| سایتای ایرانی | 🌐 | https://***.workers.dev/clash/FA |
| همه آیپیا | 4️⃣ | https://***.workers.dev/clash/ALL |
| همه سابدامین ها | 🔰⚛️ | https://***.workers.dev/clash/TEST |
| کلشون | 🔰⚛️ 4️⃣ 🌐 | https://***.workers.dev/clash/PLUS |
